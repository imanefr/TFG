        ...
        <nav class="header_pagina_barra_menu">
            ...
            <div class="header_pagina_menu_contenedor">
                ...
                <div class="header_pagina_item_menu header_pagina_desplegable <?php echo isActivePage('organigrama') || isActivePage('ampa') || isActivePage('resultados_academicos') ? 'activo' : ''; ?>">
                    <div class="header_pagina_desplegable_trigger">
                        Nuestro centro <span class="header_pagina_icono_desplegable">▾</span>
                    </div>
                ...
                <div class="header_pagina_item_menu header_pagina_desplegable <?php echo isActivePage('eso_info') || isActivePage('fp_info') || isActivePage('desarrollo_videojuegos') ? 'activo' : ''; ?>">
                    <div class="header_pagina_desplegable_trigger">
                        Oferta educativa <span class="header_pagina_icono_desplegable">▾</span>
                    </div>
                    <div class="header_pagina_submenu">
                        ...
                        <div class="header_pagina_submenu_item_desplegable">
                            <a href="#" class="header_pagina_submenu_titulo header_pagina_contenedor_titulo_nivel3 <?php echo isActivePage('fp_info') ? 'activo' : ''; ?>">Formación Profesional ▾</a>
                ...
                ?>">
                    <div class="header_pagina_desplegable_trigger">
                        Secretaría <span class="header_pagina_icono_desplegable">▾</span>
                    </div>
                    <div class="header_pagina_submenu">
                        <a href="avisos.php" class="header_pagina_submenu_titulo <?php echo isActivePage('avisos') ? 'activo' : ''; ?>">Avisos</a>

                        <div class="header_pagina_submenu_item_desplegable">
                            <a href="#" class="header_pagina_submenu_titulo header_pagina_contenedor_titulo_nivel3">Matriculación ▾</a>
                            <div class="header_pagina_submenu_anidado">
                        ...
                        <div class="header_pagina_submenu_item_desplegable">
                            <a href="#" class="header_pagina_submenu_titulo header_pagina_contenedor_titulo_nivel3">Convalidación ▾</a>
                            <div class="header_pagina_submenu_anidado">
                        ...
                        <div class="header_pagina_submenu_item_desplegable">
                            <a href="#" class="header_pagina_submenu_titulo header_pagina_contenedor_titulo_nivel3">Solicitud títulos ▾</a>
                            <div class="header_pagina_submenu_anidado">
