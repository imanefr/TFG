...
$titulo_dashboard = "Dashboard Teatro";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM teatro WHERE id = ?");
        ...
        case 'nueva':
            ...
            if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
                ...
                if (in_array($file_extension, $allowed)) {
                    $new_filename = 'teatro_' . time() . '_' . rand(1000, 9999) . '.' . $file_extension;
            ...
            $stmt = $conexion->prepare("INSERT INTO teatro (titulo, texto, link, texto_link, imagen, video, pdf, fecha_publicacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        case 'editar':
            ...
            $stmt = $conexion->prepare("
                ...
                WHERE id=?
            ");
            $stmt->bind_param("ssssssiis", $titulo, $texto, $fecha, $enlace, $texto_enlace, $imagen, $video, $pdf, $_SESSION['usuario_id'], $id);
            if ($stmt->execute())
...
if (isset($_GET['editar'])) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM teatro WHERE id = ?");
            ...
            <div class="dashboard_erasmus_seccion_lista">
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="teatro.php" class="dashboard_erasmus_noticia_enlace">
                ...
                <?php else: ?>
                    <div class="dashboard_erasmus_vacio">
                        ...
                        <h3>No hay noticias del teatro.</h3>
