...
$titulo_dashboard = "Dashboard Geografía e Historia";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM departamentos WHERE dept_id = 11 && id = ?");
        ...
        case 'editar':
            ...
            $stmt = $conexion->prepare("
                ...
                WHERE id=? && dept_id = 11
            ");
            $stmt->bind_param("sssssssssi", $titulo, $texto, $fecha, $enlace, $texto_enlace, $imagen, $video, $pdf, $_SESSION['usuario_id'], $id);
            if ($stmt->execute())
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="info_departamento.php?id=11" class="dashboard_erasmus_noticia_enlace">
