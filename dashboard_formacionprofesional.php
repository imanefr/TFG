...
$titulo_dashboard = "Dashboard Titulación Formación Profesional";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM titulo_fp WHERE id = ?");
        ...
        case 'nueva':
            ...
            $stmt = $conexion->prepare("INSERT INTO titulo_fp (titulo, texto, link, texto_link, imagen, video, pdf, fecha_publicacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
if (isset($_GET['editar'])) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM titulo_fp WHERE id = ?");
...
<head>
    ...
    <title>Gestión Titulación Formación Profesional - Dashboard Admin</title>
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="solicitud_titulo_fp.php" class="dashboard_erasmus_noticia_enlace">
