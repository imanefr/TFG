...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM departamentos WHERE dept_id = 10 && id = ?");
...
<head>
    ...
    <title>Gestión FOL - Dashboard Admin</title>
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="info_departamento.php?id=10" class="dashboard_erasmus_noticia_enlace">
