        ...
        <div class="convalidacion-contenido">
                ...
                <div class="convalidacion-layout">
                    <div class="convalidacion-logo">
                        <?php if (!empty($fila_convalidacion['imagen'])): ?>
                            <img src="data:<?php echo $fila_convalidacion['tipo_imagen']; ?>;base64,<?php echo base64_encode($fila_convalidacion['imagen']); ?>" alt="Convalidación ESO">
            ...
            <div class="info-convalidacion">
                <div class="info-card-convalidacion">
                    ...
                    <p>Regulación completa del procedimiento de convalidación de ESO según la Comunidad de Madrid.</p>
                </div>
                <div class="info-card-convalidacion">
