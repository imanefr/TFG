...
$menu_principal = [
    ...
    // ✅ TODOS ESTOS tienen dashboard real
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cuadro-menu { 
            ...
            border-top: 5px solid transparent; cursor: pointer; position: relative; overflow: hidden;
        }
        ...
        @media (max-width: 768px) { 
            ...
            .botones-directos { grid-template-columns: 1fr; }
        }
    </style>
</head>
<body>
        ...
        <?php else: ?>
            ...
            <div class="dashboard-grid">
                <?php foreach ($menu_principal as $key => $item): ?>
                    <div class="cuadro-menu" style="border-top-color: <?php echo $colores[$key] ?? '#8B5CF6'; ?>;">
                        ...
                        <div class="botones-directos">
                            <?php if (!empty($item['enlace'])): ?>
                                <!-- ✅ "Ver Página" SOLO si tiene enlace -->
                            ...
                            <?php if (!empty($item['dashboard'])): ?>
                                <!-- ✅ TODOS los que tienen dashboard van directo -->
                                <a href="<?php echo $item['dashboard']; ?>" class="submenu-item">
