...
$titulo_dashboard = "Dashboard Titulación ESO";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM titulo_eso WHERE id = ?");
...
if (isset($_GET['editar'])) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM titulo_eso WHERE id = ?");
...
<head>
    ...
    <title>Gestión Titulación ESO - Dashboard Admin</title>
