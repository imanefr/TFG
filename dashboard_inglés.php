...
$titulo_dashboard = "Dashboard Inglés";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM departamentos WHERE dept_id = 15 && id = ?");
...
<head>
    ...
    <title>Gestión Inglés - Dashboard Admin</title>
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="info_departamento.php?id=15" class="dashboard_erasmus_noticia_enlace">
