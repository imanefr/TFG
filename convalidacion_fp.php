    ...
    <section class="seccion-contenido">
        <div class="contenedor-max">
            <div class="convalidacion_simple"> <!-- Contenedor layout simple -->
                <?php
                // Consulta convalidación FP activa (solo 1 registro)
                ...
                if ($resultado && $fila = $resultado->fetch_assoc()) { // En caso de que haya datos
                ?>
                    <!-- AVISO CONVALIDACIÓN -->
...
<?php include 'footer.php'; ?>                  <!-- Llama al footer -->
