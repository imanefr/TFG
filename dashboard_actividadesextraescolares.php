...
$titulo_dashboard = "Dashboard Actividades Extraescolares";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM departamentos WHERE dept_id = 1 && id = ?");
        ...
        case 'nueva':
            ...
            $stmt = $conexion->prepare("INSERT INTO departamentos (titulo_seccion, texto_seccion, link, texto_link, imagen, video, pdf, fecha_publicacion, dept_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1)");
...
<head>
    ...
    <title>Gestión Actividades Extraescolares - Dashboard Admin</title>
            ...
            <div class="dashboard_erasmus_seccion_form <?php echo $modo_edit ? 'dashboard_erasmus_modo_edit' : ''; ?>">
                ...
                <form method="POST" class="dashboard_erasmus_form_grid" enctype="multipart/form-data">
                    ...
                    <div class="dashboard_erasmus_form_group" style="grid-column: 1 / -1;">
                        ...
                        <textarea name="texto" class="dashboard_erasmus_form_textarea" required><?php echo htmlspecialchars($modo_edit ? $noticia_edit['texto_seccion'] : ($_POST['contenido'] ?? '')); ?></textarea>
                    </div>
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="info_departamento.php?id=1" class="dashboard_erasmus_noticia_enlace">
