...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        ...
        case 'nueva':
            ...
            $stmt = $conexion->prepare("INSERT INTO resultados_academicos (titulo, texto, link, texto_link, imagen, video, pdf, fecha_publicacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="solicitud_resultados_academicos.php" class="dashboard_erasmus_noticia_enlace">
