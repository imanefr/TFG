...
$titulo_dashboard = "Dashboard Física y Química";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM departamentos WHERE dept_id = 8 && id = ?");
        ...
        case 'nueva':
            ...
            $stmt = $conexion->prepare("INSERT INTO departamentos (titulo_seccion, texto_seccion, link, texto_link, imagen, video, pdf, fecha_publicacion, dept_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 8)");
...
<head>
    ...
    <title>Gestión Física y Química - Dashboard Admin</title>
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="info_departamento.php?id=8" class="dashboard_erasmus_noticia_enlace">
