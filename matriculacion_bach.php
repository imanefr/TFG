    ...
    <div class="contenedor-max">
        <div class="hero-layout-universal">
            ...
            <div class="hero-texto-universal">
                <h1 class="hero-titulo-universal">Matriculación Bachillerato</h1>
                <p class="hero-subtitulo-universal">Información sobre la matriculación de Bachillerato</p>
            </div>
        </div>
    </div>
</section>
...
<main>
    <section class="seccion-contenido">
        <div class="contenedor-max">
            <h1 class="matriculacion_bachillerato_titulo">Información general matrícula para alumnos de Bachillerato</h1>
                            ...
                            if($result->num_rows > 0){
                                while($row = $result->fetch_assoc())
                                {
                                    ...
                                    <p class="lista_documentacion_bachillerato_item_texto">
                                        ...
                                        data-type="link" 
                                        target="_blank"
                                        class="matriculacion_bachillerato_link">
                                        <?php echo $row['titulo']; ?>
                                        </a>
                                    </p>
                                    </li>
