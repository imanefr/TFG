...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM orientacion WHERE id = ?");
        ...
        case 'nueva':
            ...
            if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
                ...
                if (in_array($file_extension, $allowed)) {
                    $new_filename = 'orientacion_' . time() . '_' . rand(1000, 9999) . '.' . $file_extension;
...
if (isset($_GET['editar'])) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM orientacion WHERE id = ?");
                        ...
                        <?php foreach ($noticias as $noticia): ?>
                            <div class="dashboard_erasmus_noticia_card">
                                ...
                                <div class="dashboard_erasmus_noticia_medios">
                                    <?php if ($noticia['link']): ?>
                                        <a href="solicitud_titulo_eso.php" class="dashboard_erasmus_noticia_enlace">
