...
$titulo_dashboard = "Dashboard Titulación Bachillerato";
...
if ($_POST && isset($_POST['accion'])) {
    switch ($_POST['accion']) {
        case 'eliminar':
            $id = (int) $_POST['id'];
            $stmt = $conexion->prepare("DELETE FROM titulo_bach WHERE id = ?");
...
if (isset($_GET['editar'])) {
    ...
    $stmt = $conexion->prepare("SELECT * FROM titulo_bach WHERE id = ?");
...
<head>
    ...
    <title>Gestión Titulación Bachillerato - Dashboard Admin</title>
