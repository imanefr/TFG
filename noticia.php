...
if ($id <= 0) {
    header("Location: ultimas_noticias.php");
    exit;
}
            ...
            <?php if ($noticia): ?>
                <article class="noticias_relevantes_post">
                    ...
                    <header class="noticias_relevantes_header">
                        ...
                        <?php if (!empty($noticia['usuario_nombre'])): ?>
                            <br><small style="color: #666;"><?php echo htmlspecialchars($noticia['usuario_nombre']); ?></small>
                        <?php endif; ?>
                    ...
                    <nav class="noticias_relevantes_navegacion">
                        <a href="ultimas_noticias.php" class="noticias_relevantes_volver">
                            ← Volver a Noticias
                        </a>
                    </nav>
                </article>
