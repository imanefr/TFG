    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-normativa, .btn-autorizacion {
    ...
    <main>
        <section class="seccion-contenido">
            <div class="solicitud-contenido">
                <?php
                $sql_solicitud = "SELECT * FROM solicitudes_titulos WHERE tipo = 'ESO' AND activo = 1 LIMIT 1";
                ...
                <?php if ($hay_media): ?>
                    <div class="solicitud-layout">
                        <div class="solicitud-icono">
                            <img src="data:<?php echo $fila_solicitud['tipo_imagen']; ?>;base64,<?php echo base64_encode($fila_solicitud['imagen']); ?>" alt="Título ESO">
                        </div>
                ...
                <div class="aviso-importante">
                    ...
                    <strong>IMPORTANTE:</strong> Verifique previamente en secretaría si su título está disponible. No se expedirán títulos sin identificación válida.
                </div>
                ...
                <div class="info-solicitud">
                    <div class="info-card-solicitud">
                        ...
                        <p>Presente DNI/NIE original para retirar título.</p>
                    </div>
                    <div class="info-card-solicitud">
                        <i class="fas fa-clock"></i>
                        <h4>Secretaría</h4>
                    ...
                    <div class="info-card-solicitud">
                        ...
                        <h4>Comunidad Madrid</h4>
                        <p>Expedición: ~18 meses tras finalizar estudios.</p>
                    </div>
                </div>
