...
// Obtener PDF e info desde base de datos
$sql = "SELECT titulo, descripcion, ruta_pdf, fecha FROM matriculacion_eso WHERE activo = 1 ORDER BY fecha DESC LIMIT 1";
...
?>
            ...
            <div class="contenedor-max">
                <div class="avisos-layout">
                    ...
                    <div class="avisos-texto">
                        <h2><?php echo $matricula ? htmlspecialchars($matricula['titulo']) : 'Matriculación ESO'; ?></h2>
                        <p><?php echo $matricula ? htmlspecialchars($matricula['descripcion']) : 'Horario secretaría: L-V 09:30-12:00'; ?></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <main>
            <?php if ($matricula && $matricula['ruta_pdf']): ?>
                            ...
                            <div class="aviso-item">
                                <div class="aviso-contenido">
                                    <p class="aviso-fecha">
                                        ...
                                        <?php echo $matricula['fecha'] ? date('d/m/Y', strtotime($matricula['fecha'])) : date('d/m/Y'); ?>
                                    </p>
                                    <h3 class="aviso-titulo">📄 Documento Oficial Matrícula ESO</h3>
                                    <p class="aviso-texto">Descarga el PDF oficial con toda la información y formularios de matrícula.</p>

                                    <div class="pdf-actions">
                                        <a href="descargar_pdf.php?id=1" class="aviso-enlace" target="_blank">
                                            <i class="fas fa-download"></i> Descargar PDF Oficial
                                        </a>
                                        <a href="ver_pdf.php?id=1" class="ver-pdf-btn" target="_blank">
                        ...
                        <div class="pasos-matricula">
                            ...
                            <div class="pasos-lista">
                                <div class="paso-item">
                                    ...
                                    <div>Formulario matrícula (en PDF oficial)</div>
                                </div>
                                <div class="paso-item">
                                    <span class="paso-numero">2</span>
                                    <div>DNI / Libro Familia (original + copia)</div>
                                </div>
                                <div class="paso-item">
                                    <span class="paso-numero">3</span>
                                    <div>Recibo Seguro Escolar 3º-4º ESO (1,12€)</div>
                                </div>
                                <div class="paso-item importante">
                                    <span class="paso-numero">★</span>
                                    <div><strong>Recibo Agenda 1º-2º ESO (3€)</strong></div>
                                </div>
                            </div>
                        </div>
                    </div>
