...
<!-- HEADER CONVALIDACION BACHILLERATO --> 
    ...
    <div class="contenedor-max">
        <div class="hero-layout-universal">
            ...
            <div class="hero-texto-universal">
                <h1 class="hero-titulo-universal">Convalidación Bachillerato</h1> <!-- Título principal -->
    ...
    <section class="seccion-contenido">
        <div class="contenedor-max">
            <div class="convalidacion_simple">
                <?php
                // Consulta convalidación BACHILLERATO activa
                ...
                <?php } else { ?> <!-- En caso de que no haya datos disponibles -->
                    <div class="convalidacion_aviso">
